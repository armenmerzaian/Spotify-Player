...
const scope: string = "user-read-email user-read-private app-remote-control playlist-read-collaborative playlist-modify-public playlist-read-private playlist-modify-private user-read-recently-played user-read-playback-position user-top-read user-follow-modify user-follow-read user-modify-playback-state user-read-playback-state user-read-currently-playing ugc-image-upload"
